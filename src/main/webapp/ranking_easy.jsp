...
<body>
	<div>
		<h1 class="title">Easy ranking</h1>
	</div>
	...
	<table>
		...
		<tbody>
			<%
			if (Ranking.rankingEasy.size() != 0)
			{
				for (Player p : Ranking.getMelhores(1)) {
					out.print("<tr><td>" + p.getNickname() + "</td><td>" + p.getScore() + "</td><td>Easy</td></tr>");
				}
			}
			else
			{
	...
	<ul id="pagination">
		...
		<li class="page-item"><a href="#" class="page-link" id="page-link-active">1</a></li>
