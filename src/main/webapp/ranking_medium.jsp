...
<body>
	<div>
		<h1 class="title">Medium ranking</h1>
	</div>
	<table>
		<thead>
			<tr>
		...
		<tbody>
			<%
			if (Ranking.rankingMedium.size() != 0)
			{
				for (Player p : Ranking.getMelhores(2)) {
					out.print("<tr><td>" + p.getNickname() + "</td><td>" + p.getScore() + "</td><td>Medium</td></tr>");
				}
			}
			else
			{
	...
	<ul id="pagination">
		...
		<li class="page-item"><a href="#" class="page-link" id="page-link-active">2</a></li>
